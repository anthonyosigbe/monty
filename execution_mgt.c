...
/**
 * execution_mgt - Manages the operations to be executed by the interpreter
 ...
 *
 * Return: 0 if the operation was executed correctly or errcode if
 * it is invalid
 */
